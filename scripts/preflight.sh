#!/usr/bin/env bash
# scripts/preflight.sh — the write gate behind Rules I-3 and I-4: ONE implementation, every platform.
#
...
install_hook() {
  ...
  cat >"$hook" <<EOF
#!/bin/sh
# mesita preflight — generated by scripts/preflight.sh install-hook; the law is scripts/preflight.sh (Rules I-3, I-4)
