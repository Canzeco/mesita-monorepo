...
| `apps/web-check` | — | Mesita Check (staff) · check.mesita.ai pending (Next.js · Vercel) — the Tickets-v2 check page's new home; web-landing still serves live QRs until the URL flip (MESITA-814) |
