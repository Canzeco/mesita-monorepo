-- MESITA-720 — projects_view INSTEAD OF triggers write embedding_source_text.
-- Companion to 20260722010331 (column + view). Split because MCP applied the
-- view first; triggers must land separately for cloud == repo.
