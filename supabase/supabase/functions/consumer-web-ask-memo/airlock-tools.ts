// airlock-tools.ts — the FIXED, read-only tool set Memo's agent may call.
//
...
import { callPerplexityChat } from "../_shared/perplexity-chat.ts";
...
import type { AirlockContext, AirlockTool, ToolResult } from "./airlock.ts";
