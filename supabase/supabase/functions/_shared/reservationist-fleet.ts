...
const A2_PROMPT = [
  ...
  `- Si es "reminder": es un RECORDATORIO — la mesa YA está confirmada para el {{reservation_date}} a las {{reservation_time}}. Recuérdale los datos. Puede confirmar que asiste, pedir un cambio (a2_confirm_reservation con new_date / new_time) o cancelar (a2_cancel_reservation).`,
