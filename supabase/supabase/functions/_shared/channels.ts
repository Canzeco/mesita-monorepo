...
// place create path (business-web-create-place, which classifies a bag of links
// into channel columns) and the Intaker (which picks the
...
import { facebookPageFromUrl } from "./channels-facebook.ts";

export { facebookPageFromUrl, fbSlugCandidate } from "./channels-facebook.ts";
