...
// the merchant of record (MESITA-1892; it hung off the organization until the
// org layer was removed). PLATFORM posture: see stripe-connect.ts for the law.
// One row per place, `stripe_account_id` unique; relaxing to shared accounts
// later means dropping the unique — the reversible direction.
//
