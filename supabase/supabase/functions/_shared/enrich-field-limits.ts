// Shared Enricher place field limits — mirrored in business-web-update-place and
...
export const ENRICH_FIELD_LIMITS = {
  ...
  description: {
    max: 2000,
    unit: "chars",
    note: "Presentation overwrite via the business Place editor (business-web-update-place). A freshly-enriched place can exceed this — see \"Description (Enricher synthesis)\".",
  },
