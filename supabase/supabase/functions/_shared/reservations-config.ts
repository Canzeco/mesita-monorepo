...
export type TestCall = { enabled: boolean; number: string };
...
// TEST_CALL_SEED in the web-admin catalog.
export const TEST_CALL_SEED: TestCall = { enabled: true, number: "+524445499597" };
