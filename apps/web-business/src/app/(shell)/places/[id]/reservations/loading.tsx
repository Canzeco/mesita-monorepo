// Reservations is a one-line summary and one row with its provider config.
// Next 16 keeps the OLD screen painted when a route has no loading boundary
// of its own, and the inherited `places/[id]/loading.tsx` is Profile's photo
// band — the shift this file prevents.
