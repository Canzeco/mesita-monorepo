// The catalogue's skeleton, in the page's own order: heading, the partnership
// strip, the filter row, then the grid. A skeleton that guesses a different
// shape ends every load in a layout shift, which is the fault MESITA-1861
// fixed on Configuration.
