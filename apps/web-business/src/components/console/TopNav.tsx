...
// Ascending scope: you, then the legal person you act for, then its
// addresses. The three entity layers read outward from the operator.
const LINKS = [
...
export function TopNav() {
  ...
  // Organization and Account are still mock; Places reads the real
  // catalogue. Only the mock ones wear the badge and the org switcher.
  const onMockRoute =
    pathname === SHELL_ROUTES.organization ||
    pathname.startsWith(SHELL_ROUTES.account);
