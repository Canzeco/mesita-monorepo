...
// The rail's pickers (MESITA-1807): a checked entry carries `aria-checked`
// through Radix's own `menuitemradio` role, and the check TRAILS the label —
// the leading slot belongs to the entry's chip or photo.
