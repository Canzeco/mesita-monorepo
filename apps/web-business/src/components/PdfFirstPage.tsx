...
// (toolbars, dark grey gutters) inside the operator card. If the document
// can't be parsed the caller falls back to the iframe.
    ...
    <div className={className}>
      <div className="relative flex justify-center p-2">
        ...
        {rendered && pageCount > 0 ? (
          <span className="bg-foreground/75 text-paper absolute right-3 bottom-3 rounded-full px-2 py-0.5 type-meta font-semibold tabular-nums">
