...
//       mobile has NOT split it; one screen still covers both. Web's Wallet
//       spent 2026-09-05 -> 09-06 as a fifth TAB at /wallet and came back to
//       this section; /wallet is a redirect source there now, and it never
//       existed here at all.
...
export const CONSUMER_ROUTES = {
  ...
  // top-level `visit` for the ticket screen (2026-09-01); web's Wallet left
  // for a tab of its own on 09-05 and was back inside `newVisit` on 09-06, so
  // the split is what stands. Mobile has NOT made
  ...
  // detour through a top-level tab), and nothing in mobile ever consumed
