...
//   · apps/web-consumer/src/lib/place-families.ts      (its twin)
...
// `supabase/functions/_shared/place-families-parity.test.ts`: it exists
// because this file shipped `wellness_spa` for two and a half weeks after the
// catalog dropped it, and was missing `sports_fitness` and `wellness_beauty`,
// with every check green (MESITA-1857). Pills render TEXT-ONLY; the emoji
// lives in the vocabulary and the consoles.
//
...
// labels for the discovery "What" pills.
 ...
 * other surface (key validation, badges, vocabulary) — this list is the
 * Filters sheet only, and it is what web has rendered since 2026-08-29.
 */
