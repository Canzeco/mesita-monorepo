...
// Home is Soon (Pato, 2026-08-28): every pill opens coming-soon. The
// shell renders no TopBar for /home, so this band IS the page's top chrome.
//
...
//
// Home is Soon (Pato, 2026-08-28). All five pills stay visible so the row
// reads as the finished shape. Un-park is soon:false + restore the page body.
