...
export function TagsBox({ place }: { place: PlaceDetail }) {
  ...
  return (
    <Box title="Tags" icon={Tags} iconColor="text-muted-foreground">
...
export function VerificationBox({ place }: { place: PlaceDetail }) {
  ...
  return (
    <Box
      ...
      iconColor={promoting ? "text-foreground" : "text-muted-foreground"}
    >
      ...
      {!promoting && (
        <a
          ...
          className="inline-flex min-h-11 items-center gap-1.5 self-start rounded-full border border-border bg-muted px-3 py-2 text-xs font-semibold text-foreground transition hover:bg-muted"
        >
...
export function DatesBox({ place }: { place: PlaceDetail }) {
  ...
  return (
    <Box title="Dates" icon={Clock} iconColor="text-muted-foreground">
      <div className="flex flex-wrap gap-2">
...
export function LinksBox({ place }: { place: PlaceDetail }) {
  ...
  return (
    <Box title="Channels" icon={Link2} iconColor="text-muted-foreground">
