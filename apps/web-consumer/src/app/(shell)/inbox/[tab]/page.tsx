...
// Legacy Inbox aliases. The three real sections (visits / reservations /
// notifications) are STATIC segments and win the match, so this dynamic
// route only ever sees old paths:
//
//   /inbox/mine · /inbox/global                 (the notifications pair)
//   /inbox/my-activity · /inbox/global-activity (their pre-rename names)
//
// /inbox/orders and /inbox/credits never reach here — both are static 308s in
// next.config.ts, which runs before this dynamic route ever matches.
//
