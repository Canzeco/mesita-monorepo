...
//
// Unlike /home there is no shared fetch here — the three sections read three
// different sources (tickets, reservations, notifications), so each leaf owns
// its own data and its own auth gate. Orders folded into Visits (MESITA-1389,
// 2026-09-06): it never had a table or an Edge Function of its own, so it
// never had a fourth source to read.
//
...
//
//   · Visits and Orders (Orders since folded into Visits) rendered their zero
//     state hard against the nav with ~700px of dead space under it, which
//     reads as a failed render. That is the exact failure EmptyState's own
//     rule #1 exists to prevent, and it was being overridden from up here.
...
// all three sections align the same way.
