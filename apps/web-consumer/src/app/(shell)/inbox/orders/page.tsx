...
//
// Parked ON PURPOSE, and parked differently from Catalog: Catalog's route
// redirected away because its data already existed. Orders has NO backing
// concept anywhere in the stack — no table, no Edge Function, no type — so
// there is nothing to redirect to and nothing to render. The section stays
// reachable and says so plainly rather than 404ing or vanishing from the nav,
// because the four-section order is the product statement and a gap in it
// would read as a bug.
//
