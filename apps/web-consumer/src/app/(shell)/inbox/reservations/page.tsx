...
// Inbox › Reservations — Upcoming + History.
//
// Canonical path is /inbox/reservations. This list used to be the top-level
// /reservations tab route; it moved when Inbox became one surface with four
// sections. /reservations and /saved/reservations both redirect here. The
// singular DETAIL did NOT move — it stays at /reservation/[id], because
// relocating the list didn't rename the object.
