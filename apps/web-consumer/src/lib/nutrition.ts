...
//
// A guest reads four facts before the file: kilocalories, then protein, carbs
// and fat. Nothing under that — no micronutrients, no percent of a daily
// value. The numbers are what the place entered. A missing object is not
// estimated, and it prints nothing rather than a zero.
...
export function nutritionLine(n: MenuNutrition | null | undefined): string | null {
  if (!n) return null;
