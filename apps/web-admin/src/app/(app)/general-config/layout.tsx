...
// becomes a card group here. Verification (3), Models (the live picks), and
...
export default function GeneralConfigLayout({
  ...
  return (
    <ConfigPageLayout
      ...
      title="General"
      description="Platform settings small enough to share a page: who may prove they own a place, which model each subsystem thinks with, and how Ojo reads a guest's screenshot proof."
    >
      {children}
    </ConfigPageLayout>
  );
