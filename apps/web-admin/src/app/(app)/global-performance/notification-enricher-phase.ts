...
const ENRICHER_PHASES: Record<PhaseKey, EnricherPhase> = {
  create: {
    label: "Create",
    blurb:
      "The CREATE function awaits four subfunctions — 1 Seed · 2 Pulse · 3 Details · 4 Semantic.",
    tone: TONES.emerald,
  },
  research: {
    label: "Research",
  ...
  contents: {
    label: "Contents",
    blurb:
      "Writes the profile — functions 7 menu · 9 description, then persists data and images and ticks 10 Semantic.",
    tone: TONES.amber,
  },
};
...
//      their own chip and update's to NO chip, so an operator is never sent
//      to read a stage EF for a beacon it did not write;
