...
// Sticks under the mobile hamburger (and at the top on desktop) so Create
// cannot scroll off and leave Enrich + Create + Enrich looking like the
// whole tool.

export function PipelineNav() {
  return (
    <nav
      aria-label="Create, Enrich, Create + Enrich"
