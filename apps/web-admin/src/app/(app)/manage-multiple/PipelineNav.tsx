...
// cannot scroll off and leave Create + Enrich looking like the whole tool.
        ...
        {PIPELINE_STEPS.map((step) => (
          <li key={step.id}>
            ...
            >
              <span
                aria-hidden
                className="bg-primary/10 text-primary inline-flex h-5 w-5 items-center justify-center rounded-full text-[11px] font-semibold tabular-nums"
              >
                {step.n}
              </span>
              {step.label}
