  ...
  return (
    <PageContainer>
      <PageHeader
        ...
        description="Claims that need a human decision. Auto-confirm policy lives on Crenup — when auto-confirm is on for a method, successful proofs never land here."
      />
