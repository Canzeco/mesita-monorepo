...
// Performance → Reservations, as a plain list.
//
...
//
// The per-booking call lifecycle (attempts, agent verdict, alternatives,
// retry schedule) was dropped in the simplification pass — agent-debugging
// detail on a page meant to be read at a glance. It still lives in the DB,
// and reservation events still appear in the Activity feed below.
//
  ...
  return (
    <section className="border-border bg-card shadow-card rounded-2xl border p-5 sm:p-6">
      ...
      <p className="text-muted-foreground mt-1 text-sm">
        Read-only — call the AI to reschedule or cancel.
      </p>
