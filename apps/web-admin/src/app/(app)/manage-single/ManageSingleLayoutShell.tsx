  ...
  return (
    <PageContainer className="pb-10 sm:pb-14">
      <PageHeader
        ...
        description="Search Mesita units or create from Google, then run Place, Reviews, Products, Promos, Performance, and Settings — super-admin access bypasses place membership."
      />
