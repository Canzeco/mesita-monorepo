...
// Filters Config shell — the header + the seven-tab strip. Mirrors the Promos
// / Memo / Enricher shells; the description switches per active tab so the
// header always says what THIS tab governs.
