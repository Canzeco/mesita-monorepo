...
export const ENGINES: {
  ...
  },
  {
    ...
    label: "Map",
    fn: "map()",
    input: "Ready pool + guest pin / map center / Monterrey.",
    process: "Nearest 50 in a large radius, distance order. Unranked. Google Nearby Search only if the Mesita pool is under 10. Pins and rail are the same set. Country chip does not cut pins.",
