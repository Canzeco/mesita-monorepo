...
// The whole Enrichment console. Was an index redirect to /config back when this
// route had three tabs. A failed GET bails at the page so no box ever renders
// against a half-loaded blob.
...
export default async function EnrichmentPage() {
  ...
  return (
    <EnrichmentClient
      ...
      initialTriggers={result.data.enrichmentTriggers}
      triggersMeta={result.data.enrichmentTriggersMeta}
    />
  );
}
