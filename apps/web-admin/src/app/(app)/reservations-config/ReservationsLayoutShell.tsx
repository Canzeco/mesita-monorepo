...
const SUBPAGE_DESCRIPTION: Record<string, string> = {
  ...
  "/reservations-config/playground":
    "Emulate a reservation as a fake user, box by box: pick the business + consumer + their phones, author the intent, tune & run, then watch each sandbox ticket's intent-by-intent lifecycle. Tickets stay in the playground sandbox — never real consumer reservations.",
};
