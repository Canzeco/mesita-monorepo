...
export function PartnerBanner({ place }: { place: MockPlace }) {
  ...
  // which meant the same thing right up until the badge moved off the cheapest
  // paid rung. A place on Mesita Pro pays every month, and this line deciding
  // on the badge would take its Manage plan door away and hand it a buy button
  // for something it already subscribes to.
  if (place.plan === "free") {
    return (
