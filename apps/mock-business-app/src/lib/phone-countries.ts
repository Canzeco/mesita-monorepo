// A SNAPSHOT of apps/web-business/src/lib/phone-countries.ts (itself generated
// there from shared/phone-countries.ts). Owned by nothing here, checked by no
// gate — see the package CLAUDE.md on why drift is not a bug in this app.
