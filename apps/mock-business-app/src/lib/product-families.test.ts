...
// with no family.
//
// So the type check moves here. A twenty-first product added to
...
//
// THE SAME FILE EXISTS IN web-business, deliberately not shared. It asserts
// the SAME property against a DIFFERENT union, which is a thing one shared
// test cannot do.
 ...
 *  it is nine lines, and a dependency for nine lines in a mock is a
 *  dependency that could become a backend. */
